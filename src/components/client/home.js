    ...
    <div className={homeStyles.container}>
       <Grid container direction="row" justifyContent="center" alignItems="center" className={homeStyles.banner}>
        ...
        <Grid item xs={6} sm={6} md={4} lg={4}>
          <div className={homeStyles.image__container}>
            <img src={products[index].image} className={homeStyles.image}
              alt='hola' />
          </div>
        </Grid>
          ...
          <div className={homeStyles.card__container}>
            <div className={homeStyles.card}>
              ...
              <div className={homeStyles.card__action}>
                ...
                <IconButton color="primary" aria-label="add to shopping cart" onClick={nextProduct} disabled={index === 4}>
                  <ArrowForwardIosIcon />
                </IconButton>
              </div>
            </div>
      ...
      <div className={homeStyles.product__list}>
        ...
        <Grid container spacing={2}>
          {
            products.map(product =>
              <Grid item xs={12} md={3} lg={3} justifyContent='center' key={product.key}>
